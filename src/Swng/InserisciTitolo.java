...
public class InserisciTitolo extends JFrame {
	...
	public InserisciTitolo(Controllore cntrl) {
		controller = cntrl;
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if((controller.checkriferimento(titolo,btnNewButton)) && (controller.categoriaDAO.checkcategoria(categoria, btnNewButton))){
					...
					controller.categoriaDAO.inseriscititolo(categoria, titolo, btnNewButton);
					textField_1.setText("");
					controller.inseriscititolo.setVisible(false);
				}
				
				
			}
		});
		btnNewButton.setIcon(new ImageIcon(InserisciTitolo.class.getResource("/Swng/loghi/icons8-aggiungi-40.png")));

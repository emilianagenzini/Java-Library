...
public class CreaCategoria extends JFrame {
	...
	public CreaCategoria(Controllore cntrl) {
		controller = cntrl;
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(controller.categoriaDAO.inseriscicategoria(nome, btnNewButton)) {
				
				textField.setText("");
				controller.creacategoria.setVisible(false);
				}
			}
		});
		btnNewButton.setBorder(null);
		btnNewButton.setBackground(new Color(128, 0, 153));
		btnNewButton.setIcon(new ImageIcon(CreaCategoria.class.getResource("/Swng/loghi/icons8-aggiungi-40.png")));
